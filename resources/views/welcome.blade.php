...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('asset/user/img/favicon.png')}}" rel="icon">
  <link href="{{asset('asset/user/img/apple-touch-icon.png')}}" rel="apple-touch-icon">

  <!-- Fonts -->
  <link href="{{asset('asset/user/https://fonts.googleapis.com')}}" rel="preconnect">
  <link href="{{asset('asset/user/https://fonts.gstatic.com')}}" rel="preconnect" crossorigin>
  <link href="{{asset('asset/user/https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap')}}" rel="stylesheet">
